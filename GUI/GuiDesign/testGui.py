...
def testFunction():
    class GuiApplication:
        def __init__(self):
            ...
            self.materialLabel = ttk.Label(self.master, text="Select the material of specimen")
            self.materialLabel.pack()
            ...
            self.indenterLabel = ttk.Label(self.master, text="Please select one of the indenters available below:")
            self.indenterLabel.pack()
            self.indenters = ('spherical', 'Vickers', 'Berkovich')
            self.indenterComboBox = ttk.Combobox(self.master, values=self.indenters, textvariable=self.indenters)
            self.indenterImageLabel = ttk.Label(self.master, image=self.sphericalIndenterImage)
            ...
            self.specimenWidthLabel = ttk.Label(self.master, text="Specimen width:")
            self.specimenWidthEntry = ttk.Entry(self.master, validate='key', validatecommand=self.vfaz, textvariable=self.specimenWidth)
            self.specimenLengthLabel = ttk.Label(self.master, text="Specimen length:")
